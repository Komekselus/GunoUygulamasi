...
class Gunlugum : AppCompatActivity() {
                    ...
                    if (kontrol.exists()) {
                        ...
                        databaseReference.child("Kullanici").child(kullaniciID).child("Gunluk").child(oAnkiYil.toString()).child(oAnkiAy.toString()).child(oAnkiGun.toString()).get().addOnSuccessListener { sonrakiGun ->
                            if (sonrakiGun.exists()) {
                                ...
                                Toast.makeText(this@Gunlugum, "Sonraki güne ait veri yok.", Toast.LENGTH_SHORT).show()
                            }
                        }
                    }
                    else {
                        Toast.makeText(this@Gunlugum, "Günlük veri yok.", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
                        ...
                        if (kontrol.exists()) {
                            ...
                            databaseReference.child("Kullanici").child(kullanidiID).child("Gunluk").child(oAnkiYil.toString()).child(oAnkiAy.toString()).child(oAnkiGun.toString()).get().addOnSuccessListener { oncekiGun ->
                                if (oncekiGun.exists()) {
                                    ...
                                    oAnkiGun++
                                    Toast.makeText(this@Gunlugum, "Önceki güne ait veri yok.", Toast.LENGTH_SHORT).show()
                                }
                            }
                        }
                        else {
                            Toast.makeText(this@Gunlugum, "Güne ait veri yok.", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            }
